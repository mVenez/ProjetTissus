...
public:
    ...
    TissuDisque(double masse_kg, Vecteur3D centre, Vecteur3D normale, double rayon, double pas_entre_deux_masse_sur_rayon, double coef_frottement, double k, double angle = M_PI/9);//Angle par défaut de 20 degrés
