...
public:
    ...
    TissuDisque(double masse_kg, Vecteur3D centre, Vecteur3D normale, double rayon, double pas_entre_deux_masse_sur_rayon, double coef_frottement, double k, bool fixe = false, double angle = M_PI/9);
        //Angle par défaut de 20 degrés, bool par défaut à false permet de fixer le dernier cercle du tissu
